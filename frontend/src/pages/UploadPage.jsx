...
const CONDITIONS = [
  { value: "model_based", label: "Model-based" },
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 flex flex-col gap-8">
      <div className="flex flex-col gap-2">
        <p className="text-3xl font-semibold tracking-tight">Interactive filter recommendation</p>
        <p className="text-sm text-gray-400">
          Upload a photo set, compare recommendation conditions, refine the edit, and export a consistent batch style.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-2">
        <label className="text-sm text-gray-400">User study condition</label>
      ...
      <button
        ...
        className="bg-blue-600 hover:bg-blue-500 disabled:opacity-40 disabled:cursor-not-allowed
          text-white font-medium py-3 rounded transition-colors"
      >
